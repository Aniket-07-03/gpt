...
import { Download, Eye, EyeOff, IndianRupee, KeyRound, PersonStanding, SendHorizonal, Shield, Unlock, Upload, User, Users } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
const VillageOverviewCard = ({ villageData, villageId }) => {
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <InfoCard
          ...
          color="bg-gradient-to-r from-orange-200 to-orange-300 text-orange-800"
...
export default VillageOverviewCard;
